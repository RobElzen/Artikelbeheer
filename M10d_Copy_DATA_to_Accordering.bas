...
''===============================||====================================
    ...
    'Dim Path As String                           ''Doe ik iets hiermee?
...
''===============================||====================================
    ...
    Dim wbName(25) As String    'characters in wbNaam (20)
...
CHECK_START:
        Call SpeedOn
        'Berekeningen van aantal characters
    ...
    For Each rCell In statusRange.Cells
        ...
        If statusRange(rCell.Row - HeadingRows, 1).Value = Aanvraag_level_44 Then             ''"DB_inleveren"
           ...
           Range("DB_Datum_IN_ACC").Cells(rCell.Row - HeadingRows, 1).Value = Now()           ''DB_Datum_IN_ACC
            ''========================================================================''
            'Controle op JA / NEE                      Als NEE dan geen controle nodig
            If Cells(rCell.Row, Range("DB_Screening.DB").Column) = "NEE" Then GoTo COPY_START
            ''========================================================================''
